...
# convert-portable-object-to-machine-object.bash
...
# http://www.kfirlavi.com/blog/2012/11/14/defensive-bash-programming/
main() {
	find "$PROGRAM_DIRECTORY" -name "*.po" -exec bash -c "msgfmt --verbose --check --statistics --output=\"\$(dirname \"{}\")/\$(basename \"{}\" .po).mo\" \"{}\"" \;
